    ...
    : QDialog(parent,f)
{
    ...
    serverIPLabel = new QLabel(QString::fromLocal8Bit("服务器地址："));
    serverIPLineEdit = new QLineEdit;
    portLabel = new QLabel(QString::fromLocal8Bit("端口："));
    portLineEdit = new QLineEdit;
    enterBtn = new QPushButton(QString::fromLocal8Bit("进入聊天室"));
...
void TcpClient::slotEnter(){
    if(!status){
        ...
        connect(tcpSocket,&QTcpSocket::readyRead,this,&TcpClient::dataReceive);
...
void TcpClient::slotConnected(){
    ...
    enterBtn->setText(QString::fromLocal8Bit("离开"));
    int length = 0;
...
void TcpClient::slotDisconnected(){
    sendBtn->setEnabled(false);
    enterBtn->setText(QString::fromLocal8Bit("进入聊天室"));
}
